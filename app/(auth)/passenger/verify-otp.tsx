/**
 * Passenger Verify OTP Screen
 * OTP verification and navigation to registration or home
 */
...
export default function PassengerVerifyOtpScreen() {
  ...
  const handleResendOtp = useCallback(async () => {
    ...
    try {
      const response = await sendOtp(phone, "passenger");
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Text
              style={{ fontFamily: "Figtree_400Regular", color: BRAND_ORANGE }}
